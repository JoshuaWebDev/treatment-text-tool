...
def format_filename(file_name, closeWindow):
...
def format_csv(self, file_name):
    ...
    input_file = self.handle_input_file(input_file_path)
    new_content = ""
    ...
    input_file.close()
    self.handle_output_file(output_file_path, new_content)


def hide_cpf(self, cpf_or_cnpj):
...
def treat_sensitive_data(self, file_name, target):
    input_file_path = os.path.join(input_folder, file_name)
    ...
    if input_file:
        ...
        self.handle_output_file(output_file_path, content)
